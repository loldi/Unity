...
public class serialMove : MonoBehaviour {
	...
	private float speedFactor = 0.0002f;
	...
	void Update () {
		...
		tank1.transform.Translate (Vector3.right * tankSpeed1 * speedFactor);
		tank2.transform.Translate (Vector3.right * tankSpeed2 * speedFactor);
